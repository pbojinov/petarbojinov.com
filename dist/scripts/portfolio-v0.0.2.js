...
(function() {
    ...
    var $intro = $('#intro'); // for checking when to animate
    ...
    var colors = ['99,189,198', '93,123,193', '151,83,170'];
    ...
    function initHeader() {
        ...
        canvas = document.getElementById('canvas-triangles');
        canvas.width = width;
    ...
    function tweenTriangle(tri) {
        ...
        var x = (circleRadius+Math.random()*100)*Math.cos(t) + width*0.5;
        var y = (circleRadius+Math.random()*100)*Math.sin(t) + height*0.5-20;
    ...
    function addListeners() {
        ...
        $(window).scroll($.throttle(scrollCheck, 500));
        $(window).resize($.throttle(resize, 500));
    }

    function scrollCheck() {
        var position = $intro.height() + $intro.position().top;
        var scrollTop = document.body.scrollTop;
        // we've passed it, stop animating
        ...
        // console.log('are we animating?', animateHeader);
    }
